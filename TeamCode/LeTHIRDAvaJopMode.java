...
@TeleOp(name="Le ItErAtIvE AvA jOp Mode", group="Iterative Opmode")
//@Disabled
public class LeTHIRDAvaJopMode extends OpMode
{
    ...
    public void loop() {
        ...
        double drive =  gamepad1.left_stick_y; // change this negative for default
        double turn  =  -gamepad1.right_stick_x; //change this positive for default
